...
export default function AdminPanel({
  ...
  const [activeTab, setActiveTab] = useState<
    "dashboard" | "companies" | "tradies" | "dids" | "settings"
  >("dashboard");
  ...
  const [isMapTradieConfirmationOpen, setIsMapTradieConfirmationOpen] =
    useState(false);
  ...
  const confirmMapTradie = async () => {
    if (!selectedCompanyId || !companyDetails?.did?.didNumber || !tradieToMap)
      return;
  ...
  const totalTradies = companies.reduce(
    (acc, c) => acc + (c.tradieCount || 0),
    0,
  );
    ...
    <div className="min-h-screen bg-[#03070b] text-white flex flex-col md:flex-row relative">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-[#090e14] border-b border-white/5 sticky top-0 z-40">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-orange-500 text-black font-black px-2 py-0.5 rounded text-[10px]">
            ADMIN
          </span>
        </div>
        <button
      ...
      <aside
        className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-[#090e14] border-r border-white/5 flex flex-col justify-between transition-transform duration-300 ease-in-out
                          ...
                          >
                            <div className="space-y-4">
                              ...
                              <div className="flex items-start justify-between gap-3">
                                ...
                                {/* Status Badges */}
                                <div className="flex items-center flex-wrap gap-1 flex-shrink-0 justify-end">
                                  {company.isPorting && (
                                  ...
                                  <span
                                    className={`text-[10px] font-bold px-2 py-0.5 rounded-full border whitespace-nowrap ${company.isActive
                            ...
                            <button
                              onClick={() =>
                                handleViewDetails(company.companyId)
                              }
                        ...
                        {filteredCompanies.length === 0 && (
                          <div className="col-span-full bg-[#090e14] border border-white/5 rounded-2xl p-16 text-center">
                            ...
                            <p className="text-sm text-zinc-500 mt-1">
                              Try resetting the status/payment parameters.
                            </p>
                          </div>
                        )}
                      </div>
              ...
              {isLoading ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredDids.map((did, index) => (
                    <div
                      key={index}
                      className="bg-[#090e14] border border-white/5 rounded-2xl p-6 space-y-4 hover:border-white/10 transition-all"
                    >
                      <div className="flex items-center justify-between">
                        <span
                      ...
                      <div>
                        <p className="text-lg font-black text-white tracking-wide font-mono">
                          {did.number}
                        </p>
                  ...
                  {filteredDids.length === 0 && (
                    <div className="col-span-full bg-[#090e14] border border-white/5 rounded-2xl p-12 text-center">
                      ...
                      <p className="text-sm text-zinc-500 mt-1">
                        No phone numbers match the search query.
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="bg-[#090e14] border border-white/5 rounded-2xl p-6 space-y-6">
                <div className="flex items-center gap-2 pb-4 border-b border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-0.5">
                      Modify default routing, system voices, and Twilio
                      integration keys.
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSaveSettings} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          defaultVoiceModel: e.target.value,
                        })
                      }
                    ...
                    >
                      <option value="mia-v2-turbo">
                        Mia.Ai v2 Turbo (Recommended)
                      </option>
                      <option value="mia-v2-hq">Mia.Ai v2 High Fidelity</option>
                      <option value="mia-v1-stable">
                        Mia.Ai v1 Legacy Stable
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setSettings({
                          ...settings,
                          billingAlertThreshold: Number(e.target.value),
                        })
                      }
                      className="w-full bg-[#12181e] border border-white/5 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-orange-500 transition-all"
                    />
                  ...
                  <div className="flex items-center gap-3 bg-[#12181e] p-4 rounded-xl border border-white/5">
                    ...
                    <div>
                      ...
                      >
                        Enable Voice Recording Logs
                      </label>
                      <span className="text-xs text-zinc-500">
                        Record inbound queries for AI diagnostics and company
                        reviews.
                      </span>
                    </div>
                  </div>
                  ...
                  {settingsSaved && (
                    <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 rounded-xl p-4 text-xs font-bold flex items-center gap-2 animate-in fade-in duration-300">
                      <CheckCircle2 size={16} /> Global configuration settings
                      saved successfully.
                    </div>
                  )}
      ...
      {isDetailsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
          ...
          {/* Modal Container */}
          <div className="relative w-full max-w-4xl max-h-[90vh] sm:max-h-[85vh] bg-[#090e14] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200 z-50">
            {/* Modal Header */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-4 sm:py-5 border-b border-white/5 bg-[#05090e]">
              <div className="flex items-center gap-3 min-w-0 flex-1">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#12181e] border border-white/5 flex items-center justify-center font-black text-[#f97316] shrink-0">
                ...
                <>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div className="bg-[#12181e] border border-white/5 rounded-xl p-5 space-y-4">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-2 text-xs">
                        <div>
                          <span className="text-zinc-500 block">
                            Customer Name
                          </span>
                          <span className="text-white font-bold">
                            {companyDetails.company.customerName}
                          </span>
                        </div>
                        <div>
                          <span className="text-zinc-500 block">
                        ...
                        <div>
                          ...
                          <span className="text-white font-mono font-bold">
                            {companyDetails.company.mobileNumber}
                          </span>
                        </div>
                        <div className="col-span-2">
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            <span
                              className={`inline-block text-[9px] font-extrabold px-1.5 py-0.5 rounded uppercase tracking-wider ${companyDetails.company.emailVerified
                            ...
                            <span
                              className={`inline-block text-[9px] font-extrabold px-1.5 py-0.5 rounded uppercase tracking-wider ${companyDetails.company.hasPaid
                                ? "bg-emerald-500/10 text-emerald-400"
                                : "bg-red-500/10 text-red-400"
                                }`}
                            >
                      ...
                      <div className="space-y-4">
                        <h4 className="text-xs font-bold text-[#f97316] uppercase tracking-wider flex items-center justify-between pb-2 border-b border-white/5">
                          <span className="flex items-center gap-2">
                            <Phone size={14} /> DID Number Allocation
                          </span>
                          {!showAllocateDidForm && (
                            <button
                              onClick={() => {
                            ...
                            >
                              <Plus size={10} />{" "}
                              {companyDetails.did ? "Reassign" : "Allocate"}
                            </button>
                          )}
                        </h4>
                        ...
                        {showAllocateDidForm ? (
                          <form
                            onSubmit={handleAllocateDid}
                            className="space-y-3 bg-[#090e14] p-4 rounded-xl border border-white/5 animate-in slide-in-from-top-2 duration-200"
                          >
                          ...
                          <div className="p-4 bg-orange-500/5 border border-[#f97316]/10 rounded-xl text-center animate-in fade-in duration-200">
                            <Phone
                              className="mx-auto text-[#f97316]/30 mb-2"
                              size={24}
                            />
                            <p className="text-xs text-zinc-500 italic">
                              No direct inbound line allocated for this company.
                            </p>
                          </div>
                        )}
                      </div>
                  ...
                  <div className="bg-[#12181e] border border-white/5 rounded-xl p-5 space-y-4">
                    <h4 className="text-xs font-bold text-[#f97316] uppercase tracking-wider flex items-center justify-between pb-2 border-b border-white/5">
                      <span className="flex items-center gap-2">
                        <Users size={14} /> Registered Tradies Directory
                      </span>
                      {!showAddTradieForm && (
                        <button
                          onClick={() => {
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                          ...
                          <div className="space-y-1">
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setTradieNotifPref(e.target.value)
                              }
                    ...
                    <div className="space-y-3">
                      ...
                      {companyDetails.tradies.length === 0 &&
                        !showAddTradieForm && (
                          <div className="p-8 text-center bg-white/[0.01] rounded-xl border border-dashed border-white/5">
                            <Users
                              className="mx-auto text-zinc-800 mb-2"
                              size={24}
                            />
                            <p className="text-xs text-zinc-500 italic">
                              No registered staff directory records found.
                            </p>
                          </div>
                        )}
                    </div>
            ...
            {/* Modal Footer */}
            <div className="flex flex-wrap items-center justify-between gap-2 px-4 sm:px-6 py-3 sm:py-4 border-t border-white/5 bg-[#05090e]">
              <div className="flex items-center gap-2">
                <button
                  onClick={handleDeleteCompany}
                  disabled={isDeletingCompany}
                  className="px-4 sm:px-5 py-2 border border-red-500/20 bg-red-500/10 hover:bg-red-500/20 text-red-500 font-bold rounded-xl text-xs transition-all disabled:opacity-50 flex items-center gap-2"
                >
                  Delete Company
                </button>
              </div>
              <button
                onClick={() => setIsDetailsModalOpen(false)}
                className="px-4 sm:px-5 py-2 border border-white/10 hover:bg-white/5 text-white font-bold rounded-xl text-xs transition-all"
              >
                Close Portal
              </button>
            </div>
      ...
      {isMapTradieConfirmationOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          <div
            className="fixed inset-0 bg-black/80 backdrop-blur-md"
            onClick={() =>
              !isMappingTradie && setIsMapTradieConfirmationOpen(false)
            }
          />
          <div className="relative w-full max-w-sm bg-[#090e14] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 text-center space-y-4">
              ...
              <p className="text-sm text-zinc-400 font-medium">
                Do you want to map this tradie to the company's DID? This will
                route incoming calls to this tradie.
              </p>
              {mapTradieError && (
      ...
      {isDeleteConfirmationOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          <div
            className="fixed inset-0 bg-black/80 backdrop-blur-md"
            onClick={() =>
              !isDeletingCompany && setIsDeleteConfirmationOpen(false)
            }
          />
          <div className="relative w-full max-w-sm bg-[#090e14] border border-white/10 rounded-2xl overflow-hidden shadow-2xl flex flex-col animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 text-center space-y-4">
      ...
      {showPortingModal && companyDetails?.portingInfo && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[70] flex items-center justify-center p-3 sm:p-4">
          <div className="bg-[#090e14] w-full max-w-2xl rounded-2xl shadow-2xl flex flex-col border border-white/10 animate-in zoom-in-95 duration-200 max-h-[95vh] sm:max-h-[90vh]">
            {/* Header */}
            <div className="flex justify-between items-center px-4 sm:px-6 py-4 sm:py-5 border-b border-white/5 shrink-0">
              <h2 className="text-lg sm:text-xl font-black text-orange-500 flex items-center gap-2 sm:gap-3">
                <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-orange-500/20 flex items-center justify-center text-orange-500 shrink-0">
                  <Phone size={15} />
                </span>
              ...
              <button
                ...
                className="text-zinc-500 hover:text-white transition-colors p-1 rounded-lg hover:bg-white/5 shrink-0"
              >
                <X size={20} />
              </button>
            </div>
                ...
                {companyDetails.portingInfo.authorisedContact && (
                  <div className="bg-[#12181e] p-2 rounded-xl border border-white/5">
                    ...
                    <span className="text-zinc-400 block">
                      <span className="text-zinc-500 text-[14px]">Given Name:  </span>
                      {companyDetails.portingInfo.authorisedContact.givenName}
                    </span>
                    <span className="text-zinc-400 block">
                      <span className="text-zinc-500 text-[14px]">Family Name:  </span>
                      {companyDetails.portingInfo.authorisedContact.familyName}
                    </span>
                    <span className="text-zinc-400 block">
                      <span className="text-zinc-500 text-[14px]">Contact Number:  </span>
                      {companyDetails.portingInfo.authorisedContact.contactNumber}
                    </span>
                  </div>
                )}
              </div>
            ...
            {/* Footer */}
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-t border-white/5 flex flex-wrap justify-end gap-2 sm:gap-3 bg-[#12181e]/50 rounded-b-2xl shrink-0">
              <button
                onClick={() => setShowPortingModal(false)}
              ...
              {companyDetails.portingInfo.supportingDocumentPath && (
                <a
                  href={`${companyDetails.portingInfo.supportingDocumentPath.replace("/var/www/tradie-agent", "")}`}
                  target="_blank"
