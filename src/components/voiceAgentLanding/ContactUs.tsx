              ...
              <div className="space-y-2 text-left">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    onChange={handleChange}
                    className="shrink-0 bg-[#12181e] border border-white/5 rounded-xl px-2 py-3 text-white focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all w-[90px] sm:w-[100px]"
                  >
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 bg-[#12181e] border border-white/5 rounded-xl px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:border-orange-500/50 focus:ring-1 focus:ring-orange-500/50 transition-all"
                  />
                </div>
              </div>
